...
#     re_path(r'^.*$', index, name='index'),   # Catch-all pattern for frontend routes
# ]
...
urlpatterns = [
    ...
    # path('navbar/', views.NavbarLinkList.as_view(), name='navbar-link-list'),
    # path('navbar/<int:pk>/', views.NavbarLinkDetail.as_view(), name='navbar-link-detail'),

    path('navbar/', views.navbarLink),
